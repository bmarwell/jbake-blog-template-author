...
Images will not be optimized on build. Instead, run `./mvnw com.github.eirslett:frontend-maven-plugin:bun@optimize-images` to optimize all images in the `target/website` folder.
Featured Images::
